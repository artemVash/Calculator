...
class AdapterDataRequest(
    ...
    inner class CardViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun setData(itemView: View, position: Int) {
            ...
            itemView.findViewById<TextView>(R.id.item_type_of_capitalization).text =
                data.typeOfCapitalization
            itemView.findViewById<TextView>(R.id.item_replenishment_in_a_month).text =
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_history_recyclerview, parent, false)
